...
import img from "../assets/somu.jpg";
import Pie from "./Piechart"; // Assuming Piechart is a separate component

const Sidebar = ({ show }) => {
  return (
    <div
      className={`position-sticky top-0 left-0 h-100 bg-light shadow-sm pe-2 ${show ? "d-block" : "d-none"}`}
      style={{
        width: "250px",
        zIndex: 1050,
    ...
    >
      <div className="text-center mt-5 mb-4">
        ...
        />
        <h5 className="text-center">Hey, Soumya</h5>
      </div>

      <ul className="list-group mb-4" style={{ background: "transparent" }}>
        <li className="list-group-item d-flex align-items-center" style={{ backgroundColor: "#3F9142", color: "#ffffff", fontWeight: "bold" }}>
